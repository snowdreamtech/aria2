...
```bash
docker run --restart=always -d -p 80:80 -p 443:443 -p 6800:6800 -p 6881-6999:6881-6999 -v ./Download:/var/lib/aria2/Download --name aria2-ariang snowdreamtech/aria2:ariang-latest
```

```bash
docker run --restart=always -d -e TZ=Asia/Shanghai -p 80:80 -p 443:443 -p 6800:6800 -p 6881-6999:6881-6999 -v ./Download:/var/lib/aria2/Download --name aria2-ariang snowdreamtech/aria2:ariang-latest
```
